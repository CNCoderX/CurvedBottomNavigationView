...
public class BottomNavigationTopEdgeTreatment extends EdgeTreatment implements Cloneable {
     ...
     */
    public BottomNavigationTopEdgeTreatment(
    ...
    public void getEdgePath(
        ...
        shapePath.addArc(
                ...
                /* startAngle= */ cutoutArcOffset + ARC_HALF,
                /* sweepAngle= */ cornerRadiusArcLength * 2);
